...
public class DefaultPlaybackController implements MediaSessionConnector.PlaybackController {
    ...
    protected int mapRepeatMode(int selectedExoPlayerRepeatMode, int repeatMode) {
        switch (repeatMode) {
        ...
        return selectedExoPlayerRepeatMode;
    }

    @Override
    public void onSetRepeatMode(Player player, int repeatMode) {
        player.setRepeatMode(mapRepeatMode(player.getRepeatMode(), repeatMode));
    }
